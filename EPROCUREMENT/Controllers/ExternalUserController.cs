...
namespace EPROCUREMENT.Controllers
{
	public class ExternalUserController : Controller
	{
        ...
        public ExternalUserController(IReleasedPackages releasedPackages , IUsersActions usersActions)
        {
		...
		public async Task<IActionResult> GetPackages(int pkg_id)
		{
			return Ok(await _releasedPackages.GetReleased_Packages(pkg_id));
		}
		...
		//public async Task<IActionResult> UpdateIndustries()
		//{
